...
#undef  LOG_TAG
#endif
#define LOG_TAG "uicomponentsex"

#if !defined(PACKAGE)
#define PACKAGE "org.example.uicomponentsex"
#endif

#define ELM_DEMO_EDJ "/opt/usr/apps/org.example.uicomponentsex/res/uicomponentsex.edj"
#define ICON_DIR "/opt/usr/apps/org.example.uicomponentsex/res/images"
