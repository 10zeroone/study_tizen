#include "hardwarekeyeventex01.h"
...
//TODO 2: 하드웨어 키 다운 이벤트의 콜백 함수
//TODO 확인 - 하드웨어 키 중에서 Volume Up 키와 Volume Down 키, 그리고 Menu 키를 눌러 봅시다. Label 위젯에 키 종류가 표시됩니다.

//on_keydown_cb() 하드웨어 키 이벤트 함수입니다.
...
on_keydown_cb(void *data, Evas *evas, Evas_Object *o, void *event_info)
{
	...
	//Evas_Event_Key_Down  형식으로 이벤트 정보가 저장되어 있습니다.
	//속성 중에서  keyname에  문자열  형식의  키값이  저장되어  있습니다. 키값의 종류는  다음과  같습니다
	//XF86Menu : Menu  키
	//XF86Home : Home  키
	//XF86Back : Back  키
	...
	//TODO 3: 키값을 Log 메시지로 확인하기
	//Home 키, Back 키, Power 키의 경우에 곧바로 확인할 수 없다는 부분을 log로 확인하기
...
create_base_gui(appdata_s *ad)
{
	...
	//TODO 1: 하드웨어 키 이벤트 구하기
	/* Hardware key event callback */
	//EVAS_CALLBACK_KEY_DOWN 는 하드웨어 키 다운 이벤트의 콜백 함수를 의미
